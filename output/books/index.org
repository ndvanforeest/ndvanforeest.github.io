...
- Capinski M., Tomasz Jerzy Zastawniak: Probability Through Problems. A
  great book, but targeted at students that like to learn a bit of
  measure theory.
...
The books are: * Think Stats * Probability and statistics for
programmers * Think Bayes * Modeling and Simulation in Python * Think
Complexity. * How to think like a computer scientist (Not strictly
necessary, but nonetheless interesting.)
