...
#+begin_figure
[[https://edwardtufte.github.io/tufte-css/img/rhino.png]]
#+end_figure
...
Assume that offers are idd rvs $\sim \Unif{[0,1]}$, and that I have to accept an offer on the spot or reject it.{{{marginnote(Hoi <img src="https://edwardtufte.github.io/tufte-css/img/rhino.png">)}}}
If rejected, the offer is retracted, hence I cannot accept it at a later date.{{{sidenote(Dit is no 2.)}}}
Under these rules, what is the best price I can expect?

 Reject it.{{{marginnote(Hoi <img src="../../images/Penguin-interviews.jpg">)}}}
